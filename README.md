...
Before installing the fun stuff, I locked down the server with Uncomplicated Firewall (UFW):
Bash
...
3. Configure the Home Router (Optional but Recommended):
